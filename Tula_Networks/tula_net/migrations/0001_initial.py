    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('from_T', models.PositiveSmallIntegerField(blank=True, null=True, verbose_name='питается от Т №')),
                ('description', models.TextField(blank=True, verbose_name='Описение')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('res', models.CharField(blank=True, max_length=32, null=True, verbose_name='РЭС')),
