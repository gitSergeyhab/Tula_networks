# Generated by Django 3.1.1 on 2020-10-12 08:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.TextField(blank=True, verbose_name='Расположение')),
                ('region', models.CharField(blank=True, max_length=32, null=True, verbose_name='Участок')),
                ('description', models.TextField(blank=True, verbose_name='Описение')),
                ...
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='substations', to='tula_net.subscriber', verbose_name='Владелец')),
            ],
            options={
